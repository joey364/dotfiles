...
class ValidatorProcess {
    ...
    async post(anyRequest, id) {
        ...
        try {
            ...
            (_b = (_a = this.proc) === null || _a === void 0 ? void 0 : _a.stdin) === null || _b === void 0 ? void 0 : _b.write(request, "utf8");
    ...
    restartChild() {
        ...
        (_a = this.proc.stdin) === null || _a === void 0 ? void 0 : _a.on("error", (error) => {
            console.log(`validator binary stdin error: ${error}`);
            this.onChildDeath();
        });
        (_b = this.proc.stdout) === null || _b === void 0 ? void 0 : _b.on("error", (error) => {
            console.log(`validator binary stdout error: ${error}`);
            this.onChildDeath();
        });
        (_c = this.proc.stderr) === null || _c === void 0 ? void 0 : _c.on("data", (data) => {
